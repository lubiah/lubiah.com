...
When anything is stated to be random, it lacks order and follows no pattern or combination.
For example, the numbers 2, 4, 6, and... 12 are not random because the various results can be predicted because they are even integers. Because you cannot forecast the future event or possibilities, the numbers 2,655,1,43,4,22 are random.

## Random Words

So, now that you've read the definition of random, I hope you have a better grasp of random objects. Random words are simply letter combinations. To put it another way, you have no idea what term is being created. We'll generate random words in a variety of formats. As you can see, there are quite a few. Don't worry, I'll go over the code in full. We will begin simply, and as we proceed, things will grow more difficult.

## Generating Random Lowercase Words

So in this section, we are going to generate random words that are lowercase letters. Open your favourite IDE and start a new file. 
